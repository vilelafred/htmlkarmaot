...
var GIF = __webpack_require__(208);

var ItemImageGenerator = function () {
    function ItemImageGenerator() {
        _classCallCheck(this, ItemImageGenerator);

        this.imageFormat = 'png';
        this.onlyPickupable = true;
    }

    _createClass(ItemImageGenerator, [{
        key: "init",
        value: function init() {
        ...
        key: "generateItemImage",
        value: function generateItemImage(imageGenerator, zip, serverId) {
            var self = this;
            ...
            var clientItemId = this.otbManager.getItem(serverId).getClientId();
            if (!clientItemId) {
            ...
            var itemSprite = imageGenerator.generateItemImageByServerId(serverId);
            if (!itemSprite) {
                setTimeout(function () {
                    self.generateItemImage(imageGenerator, zip, serverId + 1);
                }, 1);
            ...
            var palette = ctx.getImageData(0, 0, itemSprite.getWidth(), itemSprite.getHeight());
...
var itemImageGenerator = new ItemImageGenerator();
