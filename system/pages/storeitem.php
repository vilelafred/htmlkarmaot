...
if (!$logged) {
  ...
  echo '<div style="text-align: center; font-family: Verdana, sans-serif; color: #5a2800; padding: 30px;">
          <strong>You need to be logged in to access the STORE.</strong><br><br>' .
          generateLink(getLink('?subtopic=accountmanagement') . '&redirect=' . urlencode(BASE_URL . '?subtopic=points'), 'Click here to log in') .
        '</div>';
