...
$errors = array();
	...
	if($action == '')
	{
		...
		$account_points = $account_logged->getCustomField('premium_points');
		$account_backup_points = $account_logged->getCustomField('backup_points');
		...
		$twig->display('account.management.html.twig', array(
			...
			'account_backup_points' => $account_backup_points,
